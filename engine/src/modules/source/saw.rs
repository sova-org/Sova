...
/// Amplitude calibration constant for saw oscillator
...
/// Simple saw oscillator with frequency control
pub struct SawOscillator {
    dsp: Box<saw_oscillator::SawOscillator>,
    frequency: f32,
    note: Option<f32>,
    params_dirty: bool,
    sample_rate: f32,
...
impl SawOscillator {
    ...
    pub fn new() -> Self {
        let mut dsp = Box::new(saw_oscillator::SawOscillator::new());
        dsp.init(48000);
        Self {
            dsp,
            frequency: 440.0,
...
/// Creates a new saw oscillator instance
