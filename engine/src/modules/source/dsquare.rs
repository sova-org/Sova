...
use crate::dsp::oscillators::{SquareOscillator, TableLfo};
use std::any::Any;

/// Pure Rust implementation of detuned square oscillator
/// 
/// Features:
/// - Square waves with adjustable duty cycle (default 50%)
...
pub struct DSquareOscillator {
    /// Left channel square oscillator
    osc_left: SquareOscillator,
    
    /// Right channel detuned square oscillator
    osc_right: SquareOscillator,
...
impl DSquareOscillator {
    /// Create new pure Rust detuned square oscillator
    pub fn new() -> Self {
        Self {
            osc_left: SquareOscillator::new(),
            osc_right: SquareOscillator::new(),
            lfo: TableLfo::new(),
            sample_rate: 0.0,
            block_size: 0,
...
impl AudioModule for DSquareOscillator {
...
impl Source for DSquareOscillator {
...
impl ModuleMetadata for DSquareOscillator {
...
/// Parameter descriptors for dsquare oscillator
...
/// Creates a new detuned square oscillator instance
pub fn create_dsquare_oscillator() -> Box<dyn Source> {
    Box::new(DSquareOscillator::new())
}

impl Default for DSquareOscillator {
    fn default() -> Self {
        Self::new()
    }
}