...
export const helpContent: Record<string, HelpEntry> = {
	...
	'play-button': {
		title: 'Play / Pause',
		description: 'Start or stop the transport. When playing, scheduled events will be triggered.'
	},
	'beat-display': {
		title: 'Beat Counter',
	...
	'nickname-display': {
		title: 'Your Nickname',
		description: 'Your display name shown to other collaborators. Click to edit.'
	},
	'peer-count': {
		title: 'Collaborators',
	...
	'help-button': {
		title: 'Help Mode',
		description: 'You are here! Hover over elements to learn what they do. Press Escape or click again to exit.'
	},
	'add-pane': {
		title: 'Add Pane',
		description: 'Add a new pane to the layout. Panes can display different views of your project.'
	},
	'disconnect-button': {
		title: 'Disconnect',
		description: 'Disconnect from the current session and return to the login screen.'
	},

	// Pane zones
	'zone-scene': {
		title: 'Scene View',
		description: 'Visual timeline showing lines and frames. Click frames to edit their code.'
	},
	'zone-logs': {
		title: 'Log View',
	...
	'logs-filters': {
		...
		description: 'Toggle which log levels to display: Fatal, Error, Warn, Info, Debug.'
	},
	'logs-auto-scroll': {
		title: 'Auto-scroll',
	...
	'devices-tab-midi': {
		title: 'MIDI Devices',
		description: 'View and manage MIDI output devices. Connect to hardware or create virtual outputs.'
	},
	'devices-tab-osc': {
		title: 'OSC Devices',
		description: 'View and manage OSC (Open Sound Control) output devices for network communication.'
	},
	'devices-add-midi': {
		title: 'Add Virtual MIDI',
		description: 'Create a virtual MIDI output that other applications can receive from.'
	},
	'devices-add-osc': {
		title: 'Add OSC Output',
		description: 'Create an OSC output to send messages to a specific IP address and port.'
	},
	'devices-slot': {
		title: 'Device Slot',
		description: 'Assign a slot number (1-16) to reference this device in your code. Click to edit.'
	},
	'devices-status': {
		title: 'Connection Status',
		description: 'Shows whether the device is connected and ready to receive messages.'
	},
	'devices-connect': {
	...
	'snapshots-load-now': {
		title: 'Load Now',
		description: 'Load this project immediately, replacing the current session.'
	},
	'snapshots-load-end': {
		title: 'Load at End of Line',
		description: 'Queue this project to load when the current line finishes playing.'
	},
	'snapshots-delete': {
	...
	'pane-toggle-direction': {
		...
		description: 'Change the split orientation between horizontal and vertical.'
	},
	'pane-close': {
		title: 'Close Pane',
	...
	'frame-evaluate': {
		title: 'Evaluate',
		description: 'Send the code to the server for compilation. Shortcut: Cmd/Ctrl+Enter.'
	},
	'frame-close': {
		title: 'Close Editor',
