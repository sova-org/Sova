...
<div class="snapshots-view">
    ...
    <div class="table-container">
        <div class="table-header">
            ...
            <button
                class="col-tempo sortable"
                onclick={() => handleSortClick("tempo")}
            >
                Tempo{getSortIndicator("tempo")}
            </button>
            <button
                class="col-lines sortable"
                onclick={() => handleSortClick("line_count")}
            >
                    ...
                    <div class="col-name">
                        {#if $editingName === project.name}
                            <input
                                ...
                                onkeydown={(e) =>
                                    handleRenameKeydown(e, project.name)}
        ...
        <div class="modal-overlay">
            <div class="modal">
                ...
                <div class="modal-message">
                    A project named "{saveNameInput}" already exists. Overwrite
                    it?
                </div>
                <div class="modal-buttons">
                    <button
                        class="modal-button cancel"
                        onclick={cancelOverwrite}>Cancel</button
                    >
    ...
    {#if showDeleteConfirm}
        <div class="modal-overlay">
            <div class="modal delete-modal">
                ...
                <div class="modal-message">
                    Are you sure you want to delete "{showDeleteConfirm}"? This
                    cannot be undone.
                </div>
                <div class="modal-buttons">
                    <button class="modal-button cancel" onclick={cancelDelete}
                        >Cancel</button
                    >
                    <button
