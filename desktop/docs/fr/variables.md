...
`!nom` stocke le sommet de la pile. `@nom` le récupère. Les variables inconnues
renvoient 0. `,nom` stocke et conserve la valeur sur la pile :
...
Récupérer, modifier, restocker. Motif classique pour des séquences évolutives :
...
Stocker un nom de son et le réutiliser entre les frames :
...
Modifiez une frame et toutes les frames de la ligne suivent.

## Valeurs d'environnement

Valeurs en lecture seule fournies par le runtime. Les plus utiles :
