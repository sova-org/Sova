...
pub fn syntax() -> LanguageSyntax {
    ...
    LanguageSyntax {
        rules: vec![
            ...
            SyntaxRule::new(Builtin, r"\b(osc|noise|voronoi|shape|gradient|solid|rings|checker|src|text)\b"),
            ...
            SyntaxRule::new(Operator, r"\b(rotate|scale|scroll|kaleid|pixelate|repeat|scrollX|scrollY|repeatX|repeatY|polar|cart|fold)\b"),
