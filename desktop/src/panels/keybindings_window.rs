    ...
    egui::Window::new(t!("kb.title"))
        ...
        .show(ctx, |ui| {
            ...
            let left = |ui: &mut egui::Ui| {
                shortcut::section(ui, t!("kb.general"), "kb_general", |ui| {
                    shortcut::grid_row(
                        ui,
                ...
                ui.add_space(8.0);
                shortcut::section(ui, t!("kb.file"), "kb_file", |ui| {
                    shortcut::grid_row(ui, t!("kb.save_scene"), &Shortcut::cmd(Key::Char('S')));
                    shortcut::grid_row(ui, t!("kb.load_scene"), &Shortcut::cmd(Key::Char('O')));
                });

                ui.add_space(8.0);
                shortcut::section(ui, t!("kb.transport"), "kb_transport", |ui| {
                    shortcut::grid_row(ui, t!("kb.play_pause"), &Shortcut::cmd_shift(Key::Space));
                });

                ui.add_space(8.0);
                shortcut::section(ui, t!("kb.panels"), "kb_panels", |ui| {
                    ...
                    shortcut::grid_row(ui, t!("audio.title"), &Shortcut::cmd_shift(Key::Char('A')));
                    shortcut::grid_row(
                        ui,
                        t!("devices.title"),
                        &Shortcut::cmd_shift(Key::Char('I')),
                    );
                    shortcut::grid_row(ui, t!("scope.title"), &Shortcut::cmd_shift(Key::Char('O')));
                    shortcut::grid_row(
                        ui,
                        t!("spectrum.title"),
                    ...
                    shortcut::grid_row(ui, t!("chat.title"), &Shortcut::cmd_shift(Key::Char('C')));
                    shortcut::grid_row(ui, t!("cmd.logs"), &Shortcut::cmd_shift(Key::Char('L')));
                    shortcut::grid_row(
                        ui,
            ...
            let right = |ui: &mut egui::Ui| {
                ...
                shortcut::section(ui, t!("kb.scene_nav"), "kb_scene_nav", |ui| {
                    ...
                    shortcut::grid_row(ui, t!("kb.focus_mode"), &Shortcut::plain(Key::Char('F')));
                    shortcut::grid_row(
                        ui,
                    ...
                    shortcut::grid_row(ui, t!("kb.delete_frame"), &Shortcut::plain(Key::Delete));
                    ...
                    shortcut::grid_row(ui, t!("kb.move_line_left"), &Shortcut::alt(Key::Char('H')));
                    shortcut::grid_row(
                        ui,
                    ...
                    shortcut::grid_row(ui, t!("kb.clear_frame"), &Shortcut::plain(Key::Char('X')));
                ...
                ui.add_space(8.0);
                shortcut::section(ui, t!("kb.scene_edit"), "kb_scene_edit", |ui| {
                    shortcut::grid_row(ui, t!("kb.exit_edit"), &Shortcut::plain(Key::Esc));
                    shortcut::grid_row(ui, t!("kb.evaluate"), &Shortcut::cmd(Key::Enter));
                    shortcut::grid_row(ui, t!("kb.lang_selector"), &Shortcut::cmd(Key::Char('L')));
