...
use crate::widgets::{self, SceneOpacity, Spectrum, Waveform};
...
impl ScopeBarPanel {
    ...
    fn show_scope(&mut self, ui: &mut egui::Ui, aligned: &[f32], scope_settings: &ScopeSettings) {
    ...
    fn show_spectrum(
        ...
        widgets::decay_peaks(&mut self.peaks, &self.bands, spectrum_settings.peak_decay);
