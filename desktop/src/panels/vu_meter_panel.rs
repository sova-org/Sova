...
use crate::widgets::{SceneOpacity, VuMeter};
...
impl VuMeterPanel {
    ...
    pub fn show_side_panel(
        ...
        let frame = egui::Frame::side_top_panel(&ctx.style()).fill(fill);
        ...
        egui::SidePanel::new(side, "vu_meter")
            ...
            .show(ctx, |ui| {
                ...
                for (i, ch) in self.channels.iter().enumerate() {
                    ...
                    let lane_bg = ui.visuals().widgets.inactive.bg_fill;
                    VuMeter::new(ch.rms_db, ch.peak_db)
                        .paint_bar(&painter, bar_rect, accent, lane_bg);
                }
