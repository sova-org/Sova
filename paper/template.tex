...
% changes for JIM 2021 by Yann Orlarey (orlarey@grame.fr)
% changes for JIM 2023 by Paul Goutmann (paul.goutmann@etud.univ-paris8.fr)
% changes for JIM 2026 by Mathieu Giraud (double aveugle)
% -----------------------------------------------
...
\usepackage{graphicx}
%\usepackage{listing}  
% To be used with the lstlisting environment if there is insertion of source code in the document 
...
% --------------
\threeauthors
  {Raphaël Forment} {Indépendant (ECLLA UJM ?)}
  {Tanguy Dubois} {Laboratoire LS2N}
  {Loïg Jezequel} {Laboratoire LS2N}
...
Ce modèle précise les règles pour une bonne présentation des communications à proposer aux JIM 2026. Il s'inspire du modèle proposé les années précédentes.
...
\section{Police de caractères}\label{sec:typeset_text}
...
\textit{Pour la soumission, en {\bfseries double-aveugle}, ne pas indiquer les auteurs ni les organisations, mais laisser tel quel le bloc.}
