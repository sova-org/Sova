use crate::compiler::bali::bali_ast::{
    BaliContext, Statement, args::AbstractArg, args::ConcreteArg, LoopContext,
};
...
impl AbstractStatement {
    pub fn make_concrete(self, context: BaliContext) -> Statement {
        let statement = Self::internal_make_concrete(self.concrete_type, self.args, Vec::new(), self.inside_statements, self.loop_context);
    ...
    fn internal_make_concrete(
        ...
        -> Statement {
            ...
            Self::arg_make_concrete(statement_type, abstract_args, concrete_args, current_arg, inside_statements, loop_context)
    }
        ...
        -> Statement {
            ...
            match current_arg {
                AbstractArg::Alt(args, variable) => {
                    ...
                    for a in args {
                        let statement = Self::arg_make_concrete(statement_type.clone(), abstract_args.clone(), concrete_args.clone(), a, inside_statements.clone(), loop_context.clone());
                ...
                AbstractArg::Concrete(arg) => {
                    ...
                    Self::internal_make_concrete(statement_type, abstract_args, concrete_args, inside_statements, loop_context)
                },
            }
    }
}