...
![Loïg Jezequel](../assets/images/portraits/loigjezequel.png)

<div>

Loïg Jezequel has been an associate professor at Nantes University since September 2014. He teaches programming, operating systems, and computer architecture at the IUT of Nantes. His research focuses on model-checking and its applications.

- Personal page: [https://pagesperso.ls2n.fr/~jezequel-l/](https://pagesperso.ls2n.fr/~jezequel-l/)
- Research laboratory: [https://www.ls2n.fr](https://www.ls2n.fr/)
- Arts-Science collaboration projects with Athénor: [Où il est question de rythme](https://www.athenor.com/les-ateliers-la-transmission-l-education-artistique-et-culturelle/les-projets-des-ateliers/ou-il-est-question-de-rythmes) (2020-2021), [Pièce à pédales](https://www.athenor.com/les-productions-les-editions/2019-2020/pieces-a-pedale) (2020-2023).
...
![Tanguy Dubois](../assets/images/portraits/tanguydubois.png)

<div>

Tanguy Dubois is a PhD student at [LS2N laboratory](https://ls2n.fr). His thesis focuses on _Computing winning strategies for two-player games on timed Petri nets under partial observation_ (supervised by Didier Lime). He contributes his expertise in the Rust programming language and software development to the Sova project.
...
![Raphaël Forment](../assets/images/portraits/raphaelforment.png)
...
- General website: [livecoding.fr](https://livecoding.fr)
...
![Rémi Georges](../assets/images/portraits/remigeorges.png)

<div>

Rémi Georges is a sound and visual artist, composer, and music technology designer based in Lyon. He graduated with a degree in classical percussion from the Conservatory of Toulon and a master's degree in music technology from the University of Saint-Étienne. He combines old and new technologies in his personal projects, with a strong interest in using _open source_ tools and building his own tools and instruments.

- Personal website: [remigeorges.fr](https://remigeorges.fr/)
- ralt144mi: [ralt144mi.remigeorges.fr](https://ralt144mi.remigeorges.fr/)
- Music label: [BandCamp](https://ordinateurdanslatete.bandcamp.com/)
