...
date = 2024-02-05
draft = false
title = 'Semaine de résidence (28 au 28 mars 2025)'
weight = 90 
[params]
...
Le projet se rapproche doucement d'une première version collaborative utilisable. Celle-ci permettra la connexion de plusieurs musiciens, l'édition et la soumission de _scripts_ pour exécution, le contrôle de l'ensemble des paramètres du serveur. La structure du projet permet désormais d'envisager, pour les prochaines étapes de travail, d'ajouter un certain nombre de fonctionnalités :
