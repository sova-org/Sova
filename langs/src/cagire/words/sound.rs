...
pub(super) const WORDS: &[Word] = &[
    ...
    Word { name: "warp", aliases: &[], category: "Oscillator", stack: "(v.. --)", desc: "Set warp amount", example: "0.5 warp", compile: Param, varargs: true },
    Word { name: "mirror", aliases: &[], category: "Oscillator", stack: "(v.. --)", desc: "Set mirror", example: "1 mirror", compile: Param, varargs: true },
    Word { name: "harmonics", aliases: &[], category: "Oscillator", stack: "(v.. --)", desc: "Set harmonics", example: "4 harmonics", compile: Param, varargs: true },
    Word { name: "timbre", aliases: &[], category: "Oscillator", stack: "(v.. --)", desc: "Set timbre", example: "0.5 timbre", compile: Param, varargs: true },
    Word { name: "morph", aliases: &[], category: "Oscillator", stack: "(v.. --)", desc: "Set morph", example: "0.5 morph", compile: Param, varargs: true },
    Word { name: "coarse", aliases: &[], category: "Oscillator", stack: "(v.. --)", desc: "Set coarse tune", example: "12 coarse", compile: Param, varargs: true },
    ...
    Word { name: "fmfb", aliases: &[], category: "FM", stack: "(v.. --)", desc: "Set FM feedback amount", example: "0.5 fmfb", compile: Param, varargs: true },
    // Modulation
    Word { name: "vib", aliases: &[], category: "Modulation", stack: "(v.. --)", desc: "Set vibrato rate", example: "5 vib", compile: Param, varargs: true },
    Word { name: "vibmod", aliases: &[], category: "Modulation", stack: "(v.. --)", desc: "Set vibrato depth", example: "0.5 vibmod", compile: Param, varargs: true },
    Word { name: "vibshape", aliases: &[], category: "Modulation", stack: "(v.. --)", desc: "Set vibrato shape", example: "0 vibshape", compile: Param, varargs: true },
    Word { name: "am", aliases: &[], category: "Modulation", stack: "(v.. --)", desc: "Set AM frequency", example: "10 am", compile: Param, varargs: true },
    Word { name: "amdepth", aliases: &[], category: "Modulation", stack: "(v.. --)", desc: "Set AM depth", example: "0.5 amdepth", compile: Param, varargs: true },
    Word { name: "amshape", aliases: &[], category: "Modulation", stack: "(v.. --)", desc: "Set AM shape", example: "0 amshape", compile: Param, varargs: true },
    Word { name: "rm", aliases: &[], category: "Modulation", stack: "(v.. --)", desc: "Set RM frequency", example: "100 rm", compile: Param, varargs: true },
    Word { name: "rmdepth", aliases: &[], category: "Modulation", stack: "(v.. --)", desc: "Set RM depth", example: "0.5 rmdepth", compile: Param, varargs: true },
    Word { name: "rmshape", aliases: &[], category: "Modulation", stack: "(v.. --)", desc: "Set RM shape", example: "0 rmshape", compile: Param, varargs: true },
    // LFO
    Word { name: "ramp", aliases: &[], category: "LFO", stack: "(freq curve -- val)", desc: "Ramp [0,1]", example: "0.25 2.0 ramp", compile: Simple, varargs: false },
    Word { name: "range", aliases: &[], category: "LFO", stack: "(val min max -- scaled)", desc: "Scale [0,1] to [min,max]", example: "0.5 200 800 range => 500", compile: Simple, varargs: false },
    Word { name: "linramp", aliases: &[], category: "LFO", stack: "(freq -- val)", desc: "Linear ramp (curve=1)", example: "1.0 linramp", compile: Simple, varargs: false },
    Word { name: "expramp", aliases: &[], category: "LFO", stack: "(freq -- val)", desc: "Exponential ramp (curve=3)", example: "0.25 expramp", compile: Simple, varargs: false },
    Word { name: "logramp", aliases: &[], category: "LFO", stack: "(freq -- val)", desc: "Logarithmic ramp (curve=0.3)", example: "2.0 logramp", compile: Simple, varargs: false },
    Word { name: "triangle", aliases: &[], category: "LFO", stack: "(freq -- val)", desc: "Triangle wave [0,1]", example: "0.5 triangle", compile: Simple, varargs: false },
    Word { name: "perlin", aliases: &[], category: "LFO", stack: "(freq -- val)", desc: "Perlin noise [0,1]", example: "0.25 perlin", compile: Simple, varargs: false },
    // Audio-rate Modulation DSL
    Word { name: "lfo", aliases: &[], category: "Audio Modulation", stack: "(min max period -- str)", desc: "Sine oscillation", example: "200 4000 2 lfo lpf", compile: Simple, varargs: false },
    Word { name: "tlfo", aliases: &[], category: "Audio Modulation", stack: "(min max period -- str)", desc: "Triangle oscillation", example: "0.3 0.7 0.5 tlfo pan", compile: Simple, varargs: false },
    Word { name: "wlfo", aliases: &[], category: "Audio Modulation", stack: "(min max period -- str)", desc: "Sawtooth oscillation", example: "200 4000 1 wlfo lpf", compile: Simple, varargs: false },
    Word { name: "qlfo", aliases: &[], category: "Audio Modulation", stack: "(min max period -- str)", desc: "Square oscillation", example: "0.0 1.0 0.25 qlfo gain", compile: Simple, varargs: false },
    Word { name: "slide", aliases: &[], category: "Audio Modulation", stack: "(start end dur -- str)", desc: "Linear transition", example: "0 1 0.01 slide gain", compile: Simple, varargs: false },
    Word { name: "expslide", aliases: &[], category: "Audio Modulation", stack: "(start end dur -- str)", desc: "Exponential transition", example: "0 1 0.5 expslide gain", compile: Simple, varargs: false },
    Word { name: "sslide", aliases: &[], category: "Audio Modulation", stack: "(start end dur -- str)", desc: "Smooth transition", example: "200 800 1 sslide lpf", compile: Simple, varargs: false },
    Word { name: "islide", aliases: &[], category: "Audio Modulation", stack: "(start end dur -- str)", desc: "Swell transition (slow start, fast finish)", example: "200 4000 1 islide lpf", compile: Simple, varargs: false },
    Word { name: "oslide", aliases: &[], category: "Audio Modulation", stack: "(start end dur -- str)", desc: "Pluck transition (fast attack, slow settle)", example: "0 1 0.5 oslide gain", compile: Simple, varargs: false },
    Word { name: "pslide", aliases: &[], category: "Audio Modulation", stack: "(start end dur -- str)", desc: "Stair transition (8 discrete steps)", example: "0 1 2 pslide gain", compile: Simple, varargs: false },
