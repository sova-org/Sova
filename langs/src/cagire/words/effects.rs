...
pub(super) const WORDS: &[Word] = &[
    ...
    Word {
        ...
        category: "Mod FX",
        stack: "(v.. --)",
        desc: "Set feedback delay LFO rate",
        example: "2 fblfo",
        compile: Param,
        varargs: true,
    },
    ...
    Word {
        ...
        category: "Compressor",
        stack: "(v.. --)",
        desc: "Set compressor attack time",
    ...
    Word {
        ...
        category: "Compressor",
        stack: "(v.. --)",
        desc: "Set compressor release time",
