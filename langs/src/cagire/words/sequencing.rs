...
pub(super) const WORDS: &[Word] = &[
    ...
    Word {
        ...
        category: "Time",
        stack: "(bank pattern --)",
        desc: "Chain to bank/pattern when current ends",
        example: "1 4 chain",
        compile: Simple,
        varargs: false,
    },
    ...
    Word {
        ...
        category: "Context",
        stack: "(-- n)",
        desc: "Current pattern bank index (deferred)",
        example: "pbank",
    ...
    Word {
        ...
        desc: "Euclidean rhythm indices with rotation",
        example: "3 8 2 euclidrot",
        compile: Simple,
        varargs: false,
    },
    // Debug
