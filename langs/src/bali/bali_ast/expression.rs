use crate::bali::bali_ast::{constants::FUNCTION_PREFIX, function::FunctionContent, value::Value};
use sova_core::{
    log_println,
    vm::{EnvironmentFunc, Instruction, control_asm::ControlASM, variable::Variable},
};
